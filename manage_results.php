    ...
    <div class="main">
        ...
        <form action="" method="post">
            <fieldset>
                ...
                <input type="text" name="p1" id="" placeholder="Science">
                <input type="text" name="p2" id="" placeholder="Math">
                <input type="text" name="p3" id="" placeholder="English">
                <input type="text" name="p4" id="" placeholder="Nepali">
                <input type="text" name="p5" id="" placeholder="Social">
